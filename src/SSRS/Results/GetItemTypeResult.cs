namespace SSRS.Results
{
    ...
    public partial class GetItemTypeResult
    {

        private GetItemTypeResponse getItemTypeResponseField;
        ...
        public GetItemTypeResponse GetItemTypeResponse
        {
            get
            {
                return this.getItemTypeResponseField;
            }
            set
            {
                this.getItemTypeResponseField = value;
            }
        }
    }
